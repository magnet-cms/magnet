import { Avatar, AvatarFallback, AvatarImage, Logo } from '@magnet-cms/ui/components/atoms'
...
export function AuthLayout({
  ...
  const resolvedFooterText =
    footerText ??
    intl.formatMessage({
      id: 'auth.layout.dontHaveAccount',
      defaultMessage: "Don't have an account?",
    })
  const resolvedFooterLinkText =
    footerLinkText ?? intl.formatMessage({ id: 'auth.layout.signUp', defaultMessage: 'Sign up' })
  return (
        ...
        <div className="absolute inset-0">
          <img
            ...
            alt={intl.formatMessage({
              id: 'auth.layout.coverAlt',
              defaultMessage: 'Travel background',
            })}
