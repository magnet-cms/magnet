			...
			<div className="-mt-10 flex flex-col gap-3 px-5 pb-6">
					...
					<div className="flex items-center justify-between">
						<div className="flex flex-col">
							<h3 className="text-lg font-semibold tracking-tight">
								{displayName ||
									intl.formatMessage({
										id: 'auth.profilePreview.yourName',
							...
							<span className="text-muted-foreground text-sm font-medium">
								...
								{username ||
									intl.formatMessage({
										id: 'auth.profilePreview.username',
				...
				<div className="flex items-center justify-center gap-2 border-t border-border py-4">
					...
					<StatItem
						...
						label={intl.formatMessage({
							id: 'auth.profilePreview.followers',
				...
				<div className="flex items-center gap-6">
					<TabItem
						label={intl.formatMessage({
							id: 'auth.profilePreview.overview',
					...
					<TabItem
						label={intl.formatMessage({
							id: 'auth.profilePreview.reviews',
