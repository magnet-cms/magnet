...
import { FormProvider, RHFText, RHFCheckbox } from '@magnet-cms/ui/components/molecules/hook-form'
  ...
  return (
    <FormProvider {...form} onSubmit={handleSubmit} className="flex w-full max-w-sm flex-col gap-8">
      ...
      <div className="flex gap-3">
        <Button type="button" variant="outline" className="flex-1 gap-2" disabled={isLoading}>
