...
export function SetupForm({ onSubmit, onSkip, isLoading = false, defaultValues }: SetupFormProps) {
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <Input
            ...
            {...register('siteName')}
          />
          {errors.siteName && <p className="text-destructive text-xs">{errors.siteName.message}</p>}
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Select value={defaultLocale} onValueChange={(v) => setValue('defaultLocale', v)}>
