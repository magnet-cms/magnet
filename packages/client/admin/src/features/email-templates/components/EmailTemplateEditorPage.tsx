...
const INSERT_VARIABLE_COMMAND: LexicalCommand<string> = createCommand('INSERT_VARIABLE_COMMAND')
...
export function EmailTemplateEditorPage() {
  ...
  const { data: template, isLoading } = useEmailTemplateDetail(isNew ? '' : (id ?? ''))
        ...
        <div className="p-6 space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    initialConfig={{
                      ...
                      editorState: template?.body
                        ? (editor) => {
                            ...
                            const dom = parser.parseFromString(template.body, 'text/html')
            ...
            <div className="space-y-3">
              ...
              <div className="border rounded-md overflow-hidden" style={{ height: '480px' }}>
                {clientPreviewDoc ? (
                  <iframe
                    title="Email Preview"
