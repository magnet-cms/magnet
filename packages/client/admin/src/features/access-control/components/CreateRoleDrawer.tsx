...
interface CreateRoleDrawerProps {
  ...
  onCreate: (data: { name: string; displayName: string; description?: string }) => void
}

export function CreateRoleDrawer({ open, onOpenChange, onCreate }: CreateRoleDrawerProps) {
  ...
  return (
    ...
    >
      ...
      />
      <RHFText name="displayName" label="Display Name" placeholder="e.g. Content Editor" />
      <RHFTextarea
        name="description"
