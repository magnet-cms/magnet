...
function formatRelativeTime(timestamp: string, intl: ReturnType<typeof useAppIntl>): string {
  ...
  if (minutes < 60) return intl.formatRelativeTime(-minutes, 'minute', { style: 'narrow' })
  const hours = Math.floor(minutes / 60)
  if (hours < 24) return intl.formatRelativeTime(-hours, 'hour', { style: 'narrow' })
...
export function DashboardHome() {
  ...
  const { data: recentActivity, isLoading: isActivityLoading } = useRecentActivity(5)
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-sm text-white/70 mb-4">
                    {intl.formatMessage({
                      ...
                      defaultMessage: 'Learn how to consume your content via REST or GraphQL APIs.',
                    })}
                  </p>
