          ...
          <div className="h-16 flex items-center justify-between px-6">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                {intl.formatMessage({
                  id: 'media.subtitle',
                  defaultMessage: "Manage and organize your project's digital assets.",
                })}
              </p>
            </div>
          </div>
        ...
        <div className="h-16 flex items-center justify-between px-6">
          <div>
            <h1 className="text-lg font-semibold text-foreground tracking-tight">
              ...
              {currentFolder && (
                <span className="text-muted-foreground font-normal"> / {currentFolder}</span>
              )}
            </h1>
            <p className="text-xs text-muted-foreground">
              {intl.formatMessage(
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  {searchQuery
                    ...
                    : intl.formatMessage({
                        ...
                        defaultMessage: 'Upload your first asset to get started',
                      })}
                </p>
