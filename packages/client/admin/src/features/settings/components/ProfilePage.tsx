...
import { Camera, Key, Laptop, Loader2, ShieldAlert, Smartphone, User } from 'lucide-react'
        ...
        <div className="h-16 flex items-center justify-between px-6">
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              {intl.formatMessage({
                id: 'profile.subtitle',
                defaultMessage: 'Manage your account settings and security preferences.',
              })}
            </p>
          </div>
        </div>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          {intl.formatMessage({
                            ...
                            defaultMessage: 'Update your password associated with your account.',
                          })}
                        </p>
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          {intl.formatMessage({
                            ...
                            defaultMessage: "Manage devices where you're currently logged in.",
                          })}
                        </p>
                      </div>
                    </div>
