      ...
      <div className="space-y-8">
        ...
        <Card className="overflow-hidden">
          ...
          <CardContent className="px-6 pb-6 space-y-6">
            ...
            <div className="flex items-center gap-6">
              <button type="button" className="relative group cursor-pointer rounded-full">
                ...
                <div className="absolute inset-0 flex items-center justify-center rounded-full bg-foreground/50 opacity-0 transition-opacity group-hover:opacity-100">
                  <span className="text-xs font-medium text-primary-foreground">Upload</span>
                </div>
              </button>
              <div>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div className="col-span-1 space-y-1.5">
                <Label htmlFor="env" className="text-xs font-medium text-foreground">
                  Environment
                </Label>
                <Select
        ...
        <Card className="overflow-hidden">
          ...
          <div className="px-6 pb-6 space-y-5">
            ...
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-sm font-medium text-foreground">Public Logs</p>
                <p className="mt-0.5 text-xs text-muted-foreground">
