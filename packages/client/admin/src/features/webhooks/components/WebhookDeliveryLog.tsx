 ...
 */
export function WebhookDeliveryLog({ webhookId, open, onOpenChange }: WebhookDeliveryLogProps) {
              ...
              <TableBody>
                {data.items.map((delivery) => (
                  <TableRow key={delivery.id}>
                    ...
                    <TableCell className="text-sm">{delivery.retryCount}</TableCell>
                  ...
                  {intl.formatMessage(
                    {
                      ...
                      defaultMessage: 'Page {page} of {totalPages} ({total} total)',
                    },
                    {
                      page: data.page,
