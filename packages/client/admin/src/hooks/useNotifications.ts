...
export const NOTIFICATION_KEYS = {
  ...
  list: (options?: NotificationListOptions) => [...NOTIFICATION_KEYS.all, 'list', options] as const,
...
export function useMarkNotificationAsRead() {
  ...
  return useMutation<
    ...
    string,
    {
      snapshot: Array<[readonly unknown[], PaginatedNotificationRecords | undefined]>
    }
  >({
