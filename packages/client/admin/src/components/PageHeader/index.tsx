...
function isEditableTitle(title: string | EditableTitleConfig): title is EditableTitleConfig {
...
export function PageHeader<T extends string = string>({
  ...
  return (
    <>
      ...
      {/* Main Header */}
      <header className={cn('border-b bg-background z-10', sticky && 'sticky top-0', className)}>
          ...
          <div className="flex items-center gap-4">
            ...
            {tabs && (
              <>
                ...
                <PageHeaderTabs items={tabs.items} value={tabs.value} onChange={tabs.onChange} />
              </>
            )}
          </div>
