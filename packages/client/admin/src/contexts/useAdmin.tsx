...
export const AdminProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  const { data: schemas, isLoading: isSchemasLoading, error: schemasError } = useSchemas()

  const { data: settings, isLoading: isSettingsLoading, error: settingsError } = useSettings()
