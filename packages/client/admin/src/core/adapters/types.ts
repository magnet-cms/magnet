...
export interface MagnetApiAdapter {
   ...
   */
  content: {
    list<T = ContentData>(schema: string, options?: ContentQueryOptions): Promise<T[]>
    get<T = ContentData>(
      schema: string,
      documentId: string,
    ...
    unpublish(schema: string, documentId: string, locale?: string): Promise<{ success: boolean }>
    ...
    deleteLocale(schema: string, documentId: string, locale: string): Promise<{ success: boolean }>
    getLocaleStatuses(schema: string, documentId: string): Promise<Record<string, LocaleStatus>>
    getVersions(schema: string, documentId: string, locale?: string): Promise<VersionInfo[]>
   ...
   */
  notifications: {
    list(options?: NotificationListOptions): Promise<PaginatedNotificationRecords>
  ...
  activity: {
    ...
    getByEntity(entityType: string, entityId: string, limit?: number): Promise<ActivityRecord[]>
  ...
  media: {
    ...
    uploadMultiple(files: File[], options?: MediaUploadOptions): Promise<MediaItem[]>
    update(id: string, data: { alt?: string; tags?: string[]; folder?: string }): Promise<MediaItem>
