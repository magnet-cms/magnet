...
import type { MagnetApiAdapter, MagnetConfig, TokenStorage } from '../adapters/types'
...
export function MagnetProvider({ config = {}, children }: MagnetProviderProps) {
  ...
  }, [config.apiAdapter, config.apiBaseUrl, config.onUnauthorized, config.onError, tokenStorage])
