...
export function FileEditor({
  ...
  const editorTheme = themeProp ?? (resolvedTheme === 'dark' ? 'custom-dark' : 'custom-light')

  const handleBeforeMount = (monaco: Parameters<NonNullable<EditorProps['beforeMount']>>[0]) => {
