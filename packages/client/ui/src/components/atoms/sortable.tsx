...
const SortableContent = React.forwardRef<HTMLDivElement, SortableContentProps>(
  (props, forwardedRef) => {
    ...
    const items = React.useMemo(() => {
      ...
      // eslint-disable-next-line react-hooks/exhaustive-deps -- context.items/.getItemValue are stable refs; adding context object causes extra re-renders
...
export {
  ...
  SortableItemHandle,
  SortableOverlay,
  // Namespace exports for compound component pattern
  Root as SortableRoot,
  Content as SortableContentAlias,
  Item as SortableItemAlias,
  ItemHandle as SortableItemHandleAlias,
  Overlay as SortableOverlayAlias,
}
