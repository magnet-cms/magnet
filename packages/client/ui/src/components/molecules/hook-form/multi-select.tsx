...
export const RHFMultiSelect = ({
  ...
  const handleSelect = (value: string, field: ControllerRenderProps<FormValues, string>) => {
  ...
  const handleDeselect = (value: string, field: ControllerRenderProps<FormValues, string>) => {
    const currentValues = field.value || []
