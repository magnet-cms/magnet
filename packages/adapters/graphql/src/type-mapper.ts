import { GraphQLBoolean, GraphQLFloat, GraphQLList, GraphQLString } from 'graphql'
 ...
 */
export function mapPropertyTypeToGraphQL(type: string, isArray: boolean): GraphQLOutputType {
 ...
 */
export function mapPropertyTypeToGraphQLInput(type: string, isArray: boolean): GraphQLOutputType {
