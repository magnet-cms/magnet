...
`
      await writeFile(join(dir, '0002_second.js'), makeMigration('0002_second', 2000))
      await writeFile(join(dir, '0001_first.js'), makeMigration('0001_first', 1000))
      await writeFile(join(dir, '0003_third.js'), makeMigration('0003_third', 3000))
