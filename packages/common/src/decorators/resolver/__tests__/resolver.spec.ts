...
describe('Resolve', () => {
  it('stores { type, isArray: false } when given a function', () => {
    ...
    const descriptor = Object.getOwnPropertyDescriptor(ResolveFnA.prototype, 'method')!
  ...
  it('stores { type: [...], isArray: true } when given an array of functions', () => {
    ...
    const descriptor = Object.getOwnPropertyDescriptor(ResolveFnB.prototype, 'method')!
    Resolve([() => SchemaA, () => SchemaB])(ResolveFnB.prototype, 'method', descriptor)
    const metadata = Reflect.getMetadata(RESOLVE_METADATA_KEY, descriptor.value)
  ...
  it('stores options with computed isArray when given an object with single type', () => {
    ...
    const descriptor = Object.getOwnPropertyDescriptor(ResolveFnC.prototype, 'method')!
  ...
  it('computes isArray: true when given an object with array type', () => {
    ...
    const descriptor = Object.getOwnPropertyDescriptor(ResolveFnD.prototype, 'method')!
    Resolve({ type: [SchemaA, SchemaB] })(ResolveFnD.prototype, 'method', descriptor)
    const metadata = Reflect.getMetadata(RESOLVE_METADATA_KEY, descriptor.value)
    expect(metadata.isArray).toBe(true)
  })
  ...
  it('stores description from object input', () => {
    ...
    const descriptor = Object.getOwnPropertyDescriptor(ResolveFnE.prototype, 'method')!
  ...
  it('throws when object input is missing type', () => {
    ...
    const descriptor = Object.getOwnPropertyDescriptor(ResolveFnF.prototype, 'method')!
    expect(() =>
      Resolve({} as { type: typeof SchemaA })(ResolveFnF.prototype, 'method', descriptor),
  ...
  it('throws when array input contains non-functions', () => {
    ...
    const descriptor = Object.getOwnPropertyDescriptor(ResolveFnG.prototype, 'method')!
  ...
  it('throws when descriptor has no value', () => {
    ...
    expect(() =>
      Resolve(() => SchemaA)(ResolveFnH.prototype, 'method', emptyDescriptor as PropertyDescriptor),
  ...
  it('works via class decorator syntax', () => {
    ...
    const descriptor = Object.getOwnPropertyDescriptor(ResolveFnI.prototype, 'method')!
    const metadata = Reflect.getMetadata(RESOLVE_METADATA_KEY, descriptor.value)
    expect(metadata.type).toBe(SchemaA)
  })
})
