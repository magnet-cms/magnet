...
import { SettingField, Settings, getSettingFields, getSettingsOptions } from '../settings.decorator'
...
describe('getSettingFields', () => {
  ...
  it('deduplicates by propertyKey — re-decorating replaces existing entry', () => {
    ...
    expect(Reflect.getMetadata(SETTING_FIELD_METADATA_KEY, DedupA)).toHaveLength(1)
