...
import { ExtendUser, getExtendUserOptions, isUserExtension } from '../extend-user.decorator'
...
describe('Validators', () => {
  it('applies all provided validators to the target', () => {
    ...
    class ValidatorsA {
      @Validators(validator1 as PropertyDecorator, validator2 as PropertyDecorator)
      field!: string
    }
