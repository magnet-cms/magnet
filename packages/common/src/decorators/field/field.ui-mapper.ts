...
import type { UIDecoratorOptions, UISelectItem, UITypes } from '~/types/ui.types'
 ...
 */
export function mapFieldTypeToUI(type: FieldTypeId, options: BaseFieldOptions): UIDecoratorOptions {
