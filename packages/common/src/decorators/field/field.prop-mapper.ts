...
import type { BaseFieldOptions, FieldTypeId, RelationshipFieldOptions } from '~/types/field.types'
 ...
 */
export function mapFieldTypeToProp(type: FieldTypeId, options: BaseFieldOptions): PropOptions {
