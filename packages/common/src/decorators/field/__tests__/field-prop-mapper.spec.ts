...
describe('mapFieldTypeToProp', () => {
  ...
  it('maps select → String', () => {
    expect(mapFieldTypeToProp('select', { options: [] } as SelectFieldOptions).type).toBe(String)
  })

  it('maps enum → String', () => {
    expect(mapFieldTypeToProp('enum', { enum: {} } as EnumFieldOptions).type).toBe(String)
  })
  ...
  it('maps array → Array', () => {
    expect(mapFieldTypeToProp('array', { of: { type: 'text' } } as ArrayFieldOptions).type).toBe(
      Array,
    )
  })
