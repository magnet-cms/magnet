import { ValidationException, ErrorCode, MagnetError } from '@magnet-cms/common'
...
export class GlobalExceptionFilter implements ExceptionFilter {
   ...
   * Log legacy errors
   */
  private logLegacyError(exception: unknown, request: RequestWithUser, statusCode: number): void {
