...
export class RBACController {
  ...
  async duplicate(@Param('id') id: string, @Body() dto: DuplicateRoleDto): Promise<Role> {
   ...
   */
  @Get('my-permissions')
  async getMyPermissions(@Req() req: AuthenticatedRequest): Promise<{ permissions: string[] }> {
  ...
  async checkPermission(
    ...
    const hasPermission = await this.roleService.hasPermission(req.user.id, permission)
