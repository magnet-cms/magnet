...
export class NotificationSettings {
  ...
  @SettingField.Boolean({
    label: 'Email Channel',
    description: 'Send notifications via email (requires an email adapter to be configured)',
    default: false,
    section: 'channels',
    order: 2,
  })
  ...
  @SettingField.Number({
    ...
    description: 'Number of days to keep notification records before automatic cleanup',
    default: 90,
    section: 'retention',
    order: 1,
  })
