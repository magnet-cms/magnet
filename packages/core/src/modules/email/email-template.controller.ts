import type { BaseSchema, SendEmailResult } from '@magnet-cms/common'
import {
  Body,
  Controller,
  Delete,
...
export class EmailTemplateController {
   ...
   */
  @Get()
  async list(@Query() query: ListEmailTemplatesQuery): Promise<BaseSchema<EmailTemplate>[]> {
   ...
   */
  @Get('by-slug/:slug')
  async findBySlugAllLocales(@Param('slug') slug: string): Promise<BaseSchema<EmailTemplate>[]> {
   ...
   */
  @Post()
  async create(@Body() dto: CreateEmailTemplateDto): Promise<BaseSchema<EmailTemplate>> {
