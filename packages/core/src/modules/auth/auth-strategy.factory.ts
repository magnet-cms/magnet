...
export class AuthStrategyFactory {
  ...
  private static customStrategies: Map<string, AuthStrategyConstructor> = new Map()
  ...
  static getStrategy(
    ...
    if (AuthStrategyFactory.cachedStrategy && AuthStrategyFactory.configMatches(config)) {
    ...
    switch (strategyName) {
      ...
      default: {
        const CustomStrategy = AuthStrategyFactory.customStrategies.get(strategyName)
        if (CustomStrategy) {
