...
@Settings({
  ...
  sections: [
    ...
    },
    {
      ...
      label: 'Facebook',
      icon: 'facebook',
      description: 'Sign in with Facebook. Create an app at developers.facebook.com.',
      order: 8,
    },
    {
      name: 'oauth_discord',
...
export class AuthSettings {
  ...
  @SettingField.Number({
    ...
    description: 'Maximum number of simultaneous sessions per user (0 = unlimited)',
    default: 0,
    section: 'session',
    order: 4,
  })
  ...
  @SettingField.Text({
    label: 'Client Secret',
    description: 'Discord application client secret from discord.com/developers',
    section: 'oauth_discord',
    order: 2,
  })
  discordClientSecret = ''
