...
export class PluginService implements OnModuleInit {
  ...
  private discoverPlugins() {
    ...
    const providers = [...this.modulesContainer.values()]
      ...
      .filter((wrapper) => Reflect.getMetadata(PLUGIN_METADATA, wrapper.metatype as object))
    ...
    for (const wrapper of providers) {
      ...
      const metadata = Reflect.getMetadata(PLUGIN_METADATA, metatype) as PluginMetadata
