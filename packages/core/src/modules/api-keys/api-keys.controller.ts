...
import { ApiKeyService, type ApiKeyStats, type CreateApiKeyResult } from './api-keys.service'
...
export class ApiKeyController {
  ...
  async findAll(
    ...
    const keys = await this.apiKeyService.findByUser(req.user.id, includeDisabled === 'true')
  ...
  async getUsageStats(
    ...
    return this.apiKeyService.getUsageStats(id, days ? Number.parseInt(days, 10) : 7)
  }
