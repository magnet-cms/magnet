...
export class ActivityService {
	...
	async onContentCreated(
		payload: EventPayload<'content.created'>,
	): Promise<void> {
		await this.log({
	...
	async onContentUpdated(
		payload: EventPayload<'content.updated'>,
	): Promise<void> {
	...
	async onContentDeleted(
		payload: EventPayload<'content.deleted'>,
	): Promise<void> {
		await this.log({
	...
	async onContentUnpublished(
		payload: EventPayload<'content.unpublished'>,
	): Promise<void> {
		await this.log({
	...
	async onContentVersionRestored(
		payload: EventPayload<'content.version.restored'>,
	): Promise<void> {
		await this.log({
	...
	async onUserPasswordChanged(
		payload: EventPayload<'user.password_changed'>,
	): Promise<void> {
		await this.log({
	...
	async onSettingsUpdated(
		payload: EventPayload<'settings.updated'>,
	): Promise<void> {
		await this.log({
	...
	async onSettingsGroupUpdated(
		payload: EventPayload<'settings.group_updated'>,
	): Promise<void> {
		await this.log({
	...
	async onApiKeyCreated(
		payload: EventPayload<'api_key.created'>,
	): Promise<void> {
		await this.log({
	...
	async onApiKeyRevoked(
		payload: EventPayload<'api_key.revoked'>,
	): Promise<void> {
		await this.log({
	 ...
	 */
	private mapFieldChanges(
		fieldChanges: FieldChange[],
	): CreateActivityDto['changes'] {
