...
export function showSuccessMessage(config: ProjectConfig): void {
  ...
  console.log()
  console.log(
    ansis.dim('This starts Docker services, waits for the database, and launches the app.'),
  )
...
export function showErrorMessage(error: unknown): void {
  console.log()
  console.log(ansis.red.bold('Error:'), error instanceof Error ? error.message : String(error))
  console.log()
}
