import { Calendar, Hash, Link2, List, type LucideIcon, ToggleLeft, Type } from 'lucide-react'

import type { FieldType, FieldUIConfig, ValidationRule } from '../types/builder.types'
 ...
 */
export function getFieldTypeDefinition(type: FieldType): FieldTypeDefinition | undefined {
 ...
 */
export function getValidationRuleDefinition(type: string): ValidationRuleDefinition | undefined {
