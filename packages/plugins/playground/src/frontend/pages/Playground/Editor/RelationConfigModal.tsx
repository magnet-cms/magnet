  ...
  return (
    <div className="flex items-center justify-center gap-2">
      ...
      <div className="flex items-center">
        <div
          className={cn('bg-muted-foreground/60 rounded-full', small ? 'w-1.5 h-1.5' : 'w-2 h-2')}
        />
        <div className={cn('h-px bg-muted-foreground/60', small ? 'w-6' : 'w-10')} />
        <div
          className={cn(
...
export function RelationConfigModal({
  ...
  const selectedTypeOption = RELATION_TYPE_OPTIONS.find((t) => t.value === config.relationType)
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>Define how this field relates to another schema</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">The schema this field will reference</p>
          </div>
