    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="space-y-0.5">
          <label htmlFor="versioning" className="text-sm font-medium cursor-pointer">
            Enable Versioning
          </label>
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-0.5">
          ...
          <p className="text-xs text-muted-foreground">Support multiple languages for content</p>
        </div>
        <Switch
          id="i18n"
...
export function SchemaOptionsDialog({ open, onOpenChange }: SchemaOptionsDialogProps) {
