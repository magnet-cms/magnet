...
test.describe('Database Migrations', () => {
  test('API server starts successfully with auto-migration enabled', async ({ apiClient }) => {
  ...
  test('API responds quickly after migration completes on startup', async ({ apiClient }) => {
  ...
  test('multiple sequential requests succeed (no migration lock leak)', async ({ apiClient }) => {
