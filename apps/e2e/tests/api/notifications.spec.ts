...
test.describe('Notifications API', () => {
  test('full flow — send, list, unread-count, mark-as-read, mark-all-read, cleanup', async ({
    ...
    const markRes = await authenticatedApiClient.markNotificationAsRead(notificationId)
  ...
  test('GET /notifications/unread-count returns a number', async ({ authenticatedApiClient }) => {
  ...
  test('GET /notifications returns paginated list', async ({ authenticatedApiClient }) => {
