...
test.describe('OpenAPI Spec', () => {
  test('GET /oas.json returns 200 with valid OpenAPI 3.0 spec', async ({ request, apiBaseURL }) => {
  ...
  test('GET /oas.json returns JSON content-type', async ({ request, apiBaseURL }) => {
    const response = await request.get(`${apiBaseURL}/oas.json`)
  ...
  test('GET /api-docs returns 200 with Swagger UI HTML', async ({ request, apiBaseURL }) => {
  ...
  test('GET /oas.json spec contains security schemes', async ({ request, apiBaseURL }) => {
    const response = await request.get(`${apiBaseURL}/oas.json`)
    const body = await response.json()
  ...
  test('GET /oas.json spec contains content API paths', async ({ request, apiBaseURL }) => {
    const response = await request.get(`${apiBaseURL}/oas.json`)
    const body = await response.json()
