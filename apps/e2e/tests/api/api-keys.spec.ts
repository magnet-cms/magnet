...
test.describe('API Keys API', () => {
  ...
  test.describe('API Key Management', () => {
    ...
    test('POST /api/api-keys creates key with default permissions', async ({ apiClient }) => {
    ...
    test('GET /api/api-keys returns list of user API keys', async ({ apiClient }) => {
      // Create a key first
    ...
    test('GET /api/api-keys/:id returns specific key', async ({ apiClient }) => {
    ...
    test('POST /api/api-keys/:id/revoke revokes key', async ({ apiClient }) => {
      ...
      const revokeResponse = await apiClient.revokeApiKey(created.id, 'Testing revocation')
    ...
    test('GET /api/api-keys/:id/usage returns usage statistics', async ({ apiClient }) => {
    ...
    test('GET /api/api-keys/:id/usage/history returns usage history', async ({ apiClient }) => {
      const created = await apiClient.createApiKey({
  ...
  test.describe('API Key Authorization', () => {
    test('Cannot access other user API keys', async ({ apiClient, request, apiBaseURL }) => {
      const status = await apiClient.getAuthStatus()
      test.skip(status.requiresSetup !== true, 'Need fresh setup to test authorization')
