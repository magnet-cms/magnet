...
import * as __fd_glob_23 from '../content/docs/core/content-module.mdx?collection=docs'
import * as __fd_glob_24 from '../content/docs/core/database-module.mdx?collection=docs'
import * as __fd_glob_25 from '../content/docs/core/index.mdx?collection=docs'
...
import * as __fd_glob_31 from '../content/docs/migrations/best-practices.mdx?collection=docs'
import * as __fd_glob_32 from '../content/docs/migrations/cli-commands.mdx?collection=docs'
import * as __fd_glob_33 from '../content/docs/migrations/configuration.mdx?collection=docs'
import * as __fd_glob_34 from '../content/docs/migrations/index.mdx?collection=docs'
import { default as __fd_glob_7 } from '../content/docs/migrations/meta.json?collection=docs'
import * as __fd_glob_35 from '../content/docs/migrations/migration-files.mdx?collection=docs'
import * as __fd_glob_36 from '../content/docs/plugins/content-builder.mdx?collection=docs'
import * as __fd_glob_37 from '../content/docs/plugins/index.mdx?collection=docs'
import { default as __fd_glob_8 } from '../content/docs/plugins/meta.json?collection=docs'
// @ts-nocheck
import * as __fd_glob_38 from '../content/docs/plugins/seo.mdx?collection=docs'
...
export const docs = await create.docs(
	...
	},
	{
		...
		'client/admin.mdx': __fd_glob_14,
		'client/index.mdx': __fd_glob_15,
		'client/ui.mdx': __fd_glob_16,
		'common/decorators.mdx': __fd_glob_17,
		'common/field-decorators.mdx': __fd_glob_18,
		'common/index.mdx': __fd_glob_19,
		'core/admin-module.mdx': __fd_glob_20,
		'core/api-keys-module.mdx': __fd_glob_21,
		'core/auth-module.mdx': __fd_glob_22,
		'core/content-module.mdx': __fd_glob_23,
		'core/database-module.mdx': __fd_glob_24,
		'core/index.mdx': __fd_glob_25,
		'core/rbac-module.mdx': __fd_glob_26,
		'getting-started/index.mdx': __fd_glob_27,
		'getting-started/installation.mdx': __fd_glob_28,
		'getting-started/quick-start.mdx': __fd_glob_29,
		'guides/nextjs-integration.mdx': __fd_glob_30,
		'migrations/best-practices.mdx': __fd_glob_31,
		'migrations/cli-commands.mdx': __fd_glob_32,
		'migrations/configuration.mdx': __fd_glob_33,
		'migrations/index.mdx': __fd_glob_34,
		'migrations/migration-files.mdx': __fd_glob_35,
		'plugins/content-builder.mdx': __fd_glob_36,
		'plugins/index.mdx': __fd_glob_37,
		'plugins/seo.mdx': __fd_glob_38,
	},
)
