...
import * as __fd_glob_25 from '../content/docs/guides/nextjs-integration.mdx?collection=docs'
import * as __fd_glob_8 from '../content/docs/index.mdx?collection=docs'
import { default as __fd_glob_0 } from '../content/docs/meta.json?collection=docs'
import * as __fd_glob_26 from '../content/docs/plugins/content-builder.mdx?collection=docs'
import * as __fd_glob_27 from '../content/docs/plugins/index.mdx?collection=docs'
import { default as __fd_glob_7 } from '../content/docs/plugins/meta.json?collection=docs'
// @ts-nocheck
import * as __fd_glob_28 from '../content/docs/plugins/seo.mdx?collection=docs'
...
export const docs = await create.docs(
	...
	},
	{
		...
		'adapters/index.mdx': __fd_glob_9,
		'adapters/mongoose.mdx': __fd_glob_10,
		'client/admin.mdx': __fd_glob_11,
		'client/index.mdx': __fd_glob_12,
		'client/ui.mdx': __fd_glob_13,
		'common/decorators.mdx': __fd_glob_14,
		'common/field-decorators.mdx': __fd_glob_15,
		'common/index.mdx': __fd_glob_16,
		'core/admin-module.mdx': __fd_glob_17,
		...
		'guides/nextjs-integration.mdx': __fd_glob_25,
		'plugins/content-builder.mdx': __fd_glob_26,
		'plugins/index.mdx': __fd_glob_27,
		'plugins/seo.mdx': __fd_glob_28,
	},
)
