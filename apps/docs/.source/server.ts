...
export const docs = await create.docs(
	...
	},
	{
		...
		'core/admin-module.mdx': __fd_glob_21,
		'core/api-keys-module.mdx': __fd_glob_22,
		'core/auth-module.mdx': __fd_glob_23,
		'core/content-module.mdx': __fd_glob_24,
		'core/database-module.mdx': __fd_glob_25,
		'core/index.mdx': __fd_glob_26,
		'core/notifications-module.mdx': __fd_glob_27,
		'core/rbac-module.mdx': __fd_glob_28,
		'core/webhooks-module.mdx': __fd_glob_29,
		'getting-started/index.mdx': __fd_glob_30,
		'getting-started/installation.mdx': __fd_glob_31,
		'getting-started/quick-start.mdx': __fd_glob_32,
		'guides/nextjs-integration.mdx': __fd_glob_33,
		'migrations/best-practices.mdx': __fd_glob_34,
		'migrations/cli-commands.mdx': __fd_glob_35,
		'migrations/configuration.mdx': __fd_glob_36,
		'migrations/index.mdx': __fd_glob_37,
		'migrations/migration-files.mdx': __fd_glob_38,
		'plugins/content-builder.mdx': __fd_glob_39,
		'plugins/index.mdx': __fd_glob_40,
		'plugins/seo.mdx': __fd_glob_41,
		'plugins/vault.mdx': __fd_glob_42,
	},
)
