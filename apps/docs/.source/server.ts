...
import * as __fd_glob_26 from '../content/docs/common/decorators.mdx?collection=docs'
import * as __fd_glob_27 from '../content/docs/common/field-decorators.mdx?collection=docs'
import * as __fd_glob_28 from '../content/docs/common/index.mdx?collection=docs'
...
import * as __fd_glob_19 from '../content/docs/core/api-keys-module.mdx?collection=docs'
import * as __fd_glob_20 from '../content/docs/core/auth-module.mdx?collection=docs'
import * as __fd_glob_21 from '../content/docs/core/content-module.mdx?collection=docs'
import * as __fd_glob_22 from '../content/docs/core/database-module.mdx?collection=docs'
import * as __fd_glob_23 from '../content/docs/core/index.mdx?collection=docs'
import { default as __fd_glob_4 } from '../content/docs/core/meta.json?collection=docs'
import * as __fd_glob_24 from '../content/docs/core/notifications-module.mdx?collection=docs'
...
import * as __fd_glob_32 from '../content/docs/guides/nextjs-integration.mdx?collection=docs'
...
export const docs = await create.docs(
	...
	},
	{
		...
		'core/api-keys-module.mdx': __fd_glob_19,
		'core/auth-module.mdx': __fd_glob_20,
		'core/content-module.mdx': __fd_glob_21,
		'core/database-module.mdx': __fd_glob_22,
		'core/index.mdx': __fd_glob_23,
		'core/notifications-module.mdx': __fd_glob_24,
		'core/rbac-module.mdx': __fd_glob_25,
		'common/decorators.mdx': __fd_glob_26,
		'common/field-decorators.mdx': __fd_glob_27,
		'common/index.mdx': __fd_glob_28,
		'getting-started/index.mdx': __fd_glob_29,
		'getting-started/installation.mdx': __fd_glob_30,
		'getting-started/quick-start.mdx': __fd_glob_31,
		'guides/nextjs-integration.mdx': __fd_glob_32,
