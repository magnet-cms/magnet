...
import * as __fd_glob_26 from '../content/docs/core/notifications-module.mdx?collection=docs'
...
import * as __fd_glob_32 from '../content/docs/migrations/best-practices.mdx?collection=docs'
import * as __fd_glob_33 from '../content/docs/migrations/cli-commands.mdx?collection=docs'
import * as __fd_glob_34 from '../content/docs/migrations/configuration.mdx?collection=docs'
import * as __fd_glob_35 from '../content/docs/migrations/index.mdx?collection=docs'
import { default as __fd_glob_7 } from '../content/docs/migrations/meta.json?collection=docs'
import * as __fd_glob_36 from '../content/docs/migrations/migration-files.mdx?collection=docs'
...
export const docs = await create.docs(
	...
	},
	{
		...
		'core/notifications-module.mdx': __fd_glob_26,
		'core/rbac-module.mdx': __fd_glob_27,
		'getting-started/index.mdx': __fd_glob_28,
		'getting-started/installation.mdx': __fd_glob_29,
		'getting-started/quick-start.mdx': __fd_glob_30,
		'guides/nextjs-integration.mdx': __fd_glob_31,
		'migrations/best-practices.mdx': __fd_glob_32,
		'migrations/cli-commands.mdx': __fd_glob_33,
		'migrations/configuration.mdx': __fd_glob_34,
		'migrations/index.mdx': __fd_glob_35,
		'migrations/migration-files.mdx': __fd_glob_36,
