...
import * as __fd_glob_27 from '../content/docs/guides/nextjs-integration.mdx?collection=docs'
...
export const docs = await create.docs(
	...
	},
	{
		...
		'core/api-keys-module.mdx': __fd_glob_18,
		...
		'core/rbac-module.mdx': __fd_glob_23,
		'getting-started/index.mdx': __fd_glob_24,
		'getting-started/installation.mdx': __fd_glob_25,
		'getting-started/quick-start.mdx': __fd_glob_26,
		'guides/nextjs-integration.mdx': __fd_glob_27,
		'plugins/content-builder.mdx': __fd_glob_28,
		'plugins/index.mdx': __fd_glob_29,
		'plugins/seo.mdx': __fd_glob_30,
	},
)
