...
| Stripe | `@magnet-cms/plugin-stripe` | Payments, subscriptions, webhooks, admin dashboard |
| Polar | `@magnet-cms/plugin-polar` | Polar.sh billing and benefits |
| SEO | `@magnet-cms/plugin-seo` | SEO metadata (package stub — in development) |

## Installing Plugins

```bash
bun add @magnet-cms/plugin-playground
bun add @magnet-cms/plugin-sentry
bun add @magnet-cms/plugin-stripe
bun add @magnet-cms/plugin-polar
# bun add @magnet-cms/plugin-seo   # when published with a provider
```

## Registering Plugins

Add plugins to your `MagnetModule.forRoot()` provider array:
...
Pass options via each plugin's `.forRoot()` method:
...
Enable or disable plugins by conditionally including them in the provider array:
...
- [Playground](/docs/plugins/playground)
- [Sentry](/docs/plugins/sentry)
- [Stripe](/docs/plugins/stripe)
- [Polar](/docs/plugins/polar)
- [SEO](/docs/plugins/seo) (in development)
