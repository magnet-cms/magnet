...
description: Visual schema builder (Playground) for Magnet CMS
---

The **Playground** plugin (`@magnet-cms/plugin-playground`) provides a visual interface for creating and managing content schemas without writing code. It generates fully typed TypeScript schemas, controllers, services, and DTOs.
  ...
  imports: [
    MagnetModule.forRoot(
      [
        ...
        PlaygroundPlugin.forRoot({ modulesPath: './src/modules' }),
      ],
      { admin: true },
    ),
  ],
...
Playground generates a complete NestJS module:
