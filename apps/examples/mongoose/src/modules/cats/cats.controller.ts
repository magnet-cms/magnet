...
import { JwtAuthGuard } from '@magnet-cms/core'
import {
  Body,
  Controller,
  Delete,
...
export class CatsController {
  ...
  findAll(
    ...
    const castratedBool = castrated === undefined ? undefined : castrated === 'true'

    if (minWeightNum !== undefined || maxWeightNum !== undefined || castratedBool !== undefined) {
